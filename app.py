...
def gather():
    ...
    gather = Gather(numDigits=1, action="/record")
...
def record():
    ...
    if "Digits" in request.values:
        ...
        response.record(max_length=10, action="/call-waiting", recording_status_callback=f"/handle-recording?lang={language}&choice={choice}", recording_status_callback_event="completed")
